...
class Linkedin(object):
    ...
    def get_own_connections(self) -> List[Dict]:
        ...
        while last_actual_count > 0:
            ...
            data = res.json()
            last_actual_count = data["elements"].__len__()
            all_connections.extend(data.get("elements", []))
            start += count_step
    ...
    def get_group_members(self, group_id):
        """Get a full list of group members.:return: list group members
        :rtype: list
        """
